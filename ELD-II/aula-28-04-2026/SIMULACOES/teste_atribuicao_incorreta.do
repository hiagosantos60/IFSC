...
vsim work.atribuicao_sequencial(atribuicao_incorreta) 
...
force -freeze sim:/atribuicao_sequencial/a 00000001 0
force -freeze sim:/atribuicao_sequencial/b 00000000 0
run

force -freeze sim:/atribuicao_sequencial/b 00000001 0
run
force -freeze sim:/atribuicao_sequencial/b 00000010 0
run
